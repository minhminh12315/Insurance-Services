    ...
    return (
        <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                <div>
                    <h1 className="text-[24px] md:text-[28px] font-extrabold text-slate-800 mb-2">Policy Management</h1>
                    <p className="text-slate-500 text-[14px] md:text-[15px]">View and manage customer policies, coverage, and terms</p>
                </div>
                <button className="w-full sm:w-auto px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center shadow-sm" onClick={() => { setEditingPolicy(null); setShowModal(true); }}>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[1100] flex items-center justify-center p-4" onClick={() => setShowModal(false)}>
                    <div className="bg-white rounded-2xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto p-6 md:p-8" onClick={e => e.stopPropagation()}>
