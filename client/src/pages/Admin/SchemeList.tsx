...
const SchemeList = () => {
    ...
    const confirmDelete = async () => {
        ...
        try {
            const success = await schemeApi.deleteScheme(deletingId);
            if (success) {
    ...
    return (
        <div className="relative">
                            ...
                            <tr key={scheme.schemeId} className="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td className="p-4 border-b border-slate-50">
                                    <div className="flex justify-end gap-2">
                                        ...
                                        <button className="p-1.5 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors border border-red-100" onClick={() => handleDeleteClick(scheme.schemeId)}>
            ...
            <ConfirmationModal
                ...
                message="Are you sure you want to delete this insurance scheme? This action cannot be undone and may affect existing policies."
