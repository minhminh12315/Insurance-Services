    ...
    return (
        <div>
            ...
            <section className="py-16 md:py-[100px] bg-white">
                <div className="max-w-[1200px] mx-auto px-5 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[50px] items-start">
                    {/* Contact Form */}
                    <div>
                        <h2 className="text-[32px] sm:text-[36px] font-bold text-[#0a1628] mb-4 sm:mb-5 leading-[1.3]">
                            If You Have Any Query, Please Contact Us
                        </h2>
                        <p className="text-[#666] leading-[1.8] mb-8 sm:mb-[35px] text-sm sm:text-[15px]">
            ...
            {/* Contact Info Cards */}
            <section className="pb-16 md:pb-[100px] bg-white">
                <div className="max-w-[1200px] mx-auto px-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-[30px]">
                        {/* Address Card */}
                        <div className="bg-[#f8f9fa] p-8 sm:p-[35px_30px] rounded-[20px] text-center transition-all duration-300 hover:md:-translate-y-[10px] hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)] group">
                            <div className="w-[60px] h-[60px] sm:w-[70px] sm:h-[70px] bg-[linear-gradient(135deg,#015fc9_0%,#007bff_100%)] rounded-full flex items-center justify-center mx-auto mb-5 transition-transform duration-300 group-hover:scale-110">
                                <svg className="w-6 h-6 sm:w-7 sm:h-7" viewBox="0 0 24 24" fill="white">
                                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
                                    <circle cx="12" cy="10" r="3" fill="#015fc9" />
                                </svg>
                            </div>
                            <h4 className="text-lg sm:text-xl font-semibold text-[#0a1628] mb-2.5">
                                Address
                            </h4>
                            <p className="text-[#666] text-sm sm:text-[15px] leading-[1.6]">
                        ...
                        {/* Email Card */}
                        <div className="bg-[#f8f9fa] p-8 sm:p-[35px_30px] rounded-[20px] text-center transition-all duration-300 hover:md:-translate-y-[10px] hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)] group sm:col-span-2 lg:col-span-1">
                            <div className="w-[60px] h-[60px] sm:w-[70px] sm:h-[70px] bg-[linear-gradient(135deg,#015fc9_0%,#007bff_100%)] rounded-full flex items-center justify-center mx-auto mb-5 transition-transform duration-300 group-hover:scale-110">
                                <svg className="w-6 h-6 sm:w-7 sm:h-7" viewBox="0 0 24 24" fill="white">
